...
(function(window) {
    ...
    /**
     * Constructor of StableReg object
     * @constructor
     */
    webgazer.reg.StableReg = function() {
     ...
     */
    webgazer.reg.StableReg.prototype.addData = function(eyes, screenPos, type) {
        if (!eyes) {
            return;
        }
     ...
     * @returns {Object}
     */
    webgazer.reg.StableReg.prototype.predict = function(eyesObj) {
     ...
     */
    webgazer.reg.StableReg.prototype.setData = function(data) {
     ...
     */
    webgazer.reg.StableReg.prototype.getData = function() {
        return this.dataClicks.data.concat(this.dataTrail.data);
    };

    /**
     * The StableReg object name
     * @type {string}
     */
    webgazer.reg.StableReg.prototype.name = 'stable';
